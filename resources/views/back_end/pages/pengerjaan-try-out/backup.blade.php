                ...
                <div class="row">
                                                ...
                                                <div class="green-radio color-green">
                                                    <ol type="A">
                                                        <li class="font-size-30 answer-number">
                                                            <input type="radio" data-alternatetype="radio" name="fieldName[0]" data-alternateName="answer[0]" data-alternateValue="A" value="1" id="answer-0-1"/><label for="answer-0-1" class="answer-text"><span></span> &nbsp;{{strip_tags($data->pilihan_a)}} </label>
                                                        </li>
                                                        <li class="font-size-30 answer-number">
                                                            <input type="radio" data-alternatetype="radio" name="fieldName[0]" data-alternateName="answer[0]" data-alternateValue="B" value="2" id="answer-0-2"/><label for="answer-0-2" class="answer-text"><span></span> &nbsp;{{strip_tags($data->pilihan_b)}} </label>
                                                        </li>
                                                        <li class="font-size-30 answer-number">
                                                            <input type="radio" data-alternatetype="radio" name="fieldName[0]" data-alternateName="answer[0]" data-alternateValue="C" value="3" id="answer-0-3"/><label for="answer-0-3" class="answer-text"><span></span> &nbsp;{{strip_tags($data->pilihan_c)}} </label>
                                                        </li>
                                                        <li class="font-size-30 answer-number">
                                                            <input type="radio" data-alternatetype="radio" name="fieldName[0]" data-alternateName="answer[0]" data-alternateValue="D" value="4" id="answer-0-4"/><label for="answer-0-4" class="answer-text"><span></span> &nbsp;{{strip_tags($data->pilihan_d)}} </label>
                                                        </li>
                                                        <li class="font-size-30 answer-number">
                                                            <input type="radio" data-alternatetype="radio" name="fieldName[0]" data-alternateName="answer[0]" data-alternateValue="E" value="5" id="answer-0-5"/><label for="answer-0-5" class="answer-text"><span></span> &nbsp;{{strip_tags($data->pilihan_e)}} </label>
                                                        </li>
                                                    </ol>
                                                </div>
                                            </div>
                    ...
                    <div class="col-lg-4 col-md-3">
                        ...
                        <div class="card-group answer">
                            <div class="card question-response-rows" data-question="1"">
