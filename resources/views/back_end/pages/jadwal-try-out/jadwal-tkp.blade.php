...
<div class="modal fade" id="modalDetail"  data-backdrop="static" tabindex="-1" aria-labelledby="modalDetailLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        ...
        <form action="{{route('pembelian-jadwal.tkp')}}" method="post" class="submitPurchase">
            @csrf
    ...
    <script>
        $(document).ready(() => {
            ...
            $(".modalShow").on("click", function() {
                ...
                $.get('/home/jadwal-try-out/tkp/get-data/'+id_paket, (data) => {
                ...
                $.get('/home/jadwal-try-out/tkp/data-jadwal/'+id+'/'+id_paket, (data) => {
                    $("#id_paket").val(data[0].id_paket);
                    $("#harga_paket").val(data[0].harga);
                })

                $.get('/home/jadwal-try-out/tkp/cek/'+id_paket, (data) => {
                    if(data.length > 0){
                        $("#beliTryOut").remove();
