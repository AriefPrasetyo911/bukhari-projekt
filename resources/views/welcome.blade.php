...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="stylesheet" href="{{asset('css/eclipse/linearicons.css')}}" />
        <link rel="stylesheet" href="{{asset('css/eclipse/font-awesome.min.css')}}" />
        <link rel="stylesheet" href="{{asset('css/eclipse/bootstrap.css')}}" />
        <link rel="stylesheet" href="{{asset('css/eclipse/magnific-popup.css')}}" />
        <link rel="stylesheet" href="{{asset('css/eclipse/owl.carousel.css')}}" />
        <link rel="stylesheet" href="{{asset('css/eclipse/nice-select.c')}}ss">
        <link rel="stylesheet" href="{{asset('css/eclipse/hexagons.min.css')}}" />
        <link rel="stylesheet" href="{{asset('https://cdn.jsdelivr.net/themify-icons/0.1.2/css/themify-icons.css')}}" />
        <link rel="stylesheet" href="{{asset('css/eclipse/main.css')}}" />
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
  ...
  <!-- ================ End footer Area ================= -->
    ...
    <script src="{{asset('js/eclipse/jquery.ajaxchimp.min.js')}}"></script>
    <script src="{{asset('js/eclipse/jquery.magnific-popup.min.js')}}"></script>
    <script src="{{asset('js/eclipse/parallax.min.js')}}"></script>
    <script src="{{asset('js/eclipse/owl.carousel.min.js')}}"></script>
    <script src="{{asset('js/eclipse/jquery.sticky.js')}}"></script>
    <script src="{{asset('js/eclipse/hexagons.min.js')}}"></script>
    <script src="{{asset('js/eclipse/jquery.counterup.min.js')}}"></script>
    <script src="{{asset('js/eclipse/waypoints.min.js')}}"></script>
    <script src="{{asset('js/eclipse/jquery.nice-select.min.js')}}"></script>
    <script src="{{asset('js/eclipse/main.js')}}"></script>
</html>
